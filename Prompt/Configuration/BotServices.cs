                    ...
                    case ServiceTypes.Luis:
                        {
                            ...
                            var serviceName = service.Name.Split("_").LastOrDefault();
                            if (string.IsNullOrWhiteSpace(serviceName))
                            {
                                throw new InvalidOperationException($"Luis Application name doesn't contain underscore ({service.Name}). Verify msbot-generated bot configuration being used.");
                            }

                            LuisServices.Add(serviceName, new LuisRecognizer(luisApp));
                            break;
                        }
